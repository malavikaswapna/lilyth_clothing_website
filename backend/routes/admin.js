...
// Reports - IMPORTANT: Specific routes MUST come before parameterized routes
router.get('/reports/sales', getSalesReport);
router.get('/reports/inventory', getInventoryReport);
router.get('/reports/customers', getCustomersReport);

// Export routes - Specific exports first, then parameterized route
router.get('/reports/sales/export', (req, res) => {
  // Manually set the reportType since it's not coming from params
...
// Fallback parameterized route (this should come last)
