        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-description">
              Curated fashion pieces that celebrate your individuality. From elegant essentials 
              to statement pieces, find clothing that fits your lifestyle and expresses your unique style.
            </p>
            <div className="hero-actions">
              ...
              <Link to="/shop?newArrivals=true" className="btn btn-outline btn-lg">
                New Arrivals
              </Link>
            </div>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-item">
              ...
              <p className="feature-description">
                Free shipping on orders over ₹2000. Fast and reliable delivery to your door.
              </p>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
            ...
            <div className="feature-item">
              ...
              <p className="feature-description">
                Every piece is carefully selected for superior quality and timeless style.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="categories">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">Discover pieces that define your style</p>
          </div>
          <div className="categories-grid">
            ...
            <Link to="/shop?category=activewear" className="category-card large">
              <img 
          ...
          <div className="philosophy-content">
            <div className="philosophy-text">
              ...
              <p className="philosophy-description">
                At LILYTH, we believe that the perfect fit goes beyond measurements. 
                It's about finding pieces that align with your lifestyle, express your 
                personality, and make you feel confident in your own skin.
              </p>
              <p className="philosophy-description">
                Every piece in our collection is chosen for its quality, versatility, 
                and timeless appeal. We're here to help you build a wardrobe that truly fits you.
              </p>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <p className="cta-description">
              Join the Lilyth community and discover clothing that truly fits your style.
            </p>
            <Link to="/shop" className="btn btn-primary btn-lg">
              Start Shopping
              <ArrowRight size={18} />
