...
const Shop = () => {
  ...
  const updateFilter = (key, value) => {
    ...
    Object.keys(newFilters).forEach(key => {
      if (newFilters[key] && newFilters[key] !== false && newFilters[key] !== '') {
          ...
          <div className="shop-title-section">
            ...
            {!loading && (
              <p className="shop-subtitle">
                {pagination.total || 0} {pagination.total === 1 ? 'item' : 'items'}
              </p>
            )}
          </div>
            ...
            <div className="filter-section">
              ...
              <div className="filter-options">
                {categories.map(category => (
                  <label key={category._id || category.slug} className="filter-option">
                    <input
                      type="radio"
                      name="category"
                      value={category.slug}
            ...
            <div className="filter-section">
              ...
              <div className="color-options">
                {colorOptions.map(color => (
                  <button
                    key={color.value}
                    className={`color-btn ${filters.color === color.value ? 'active' : ''}`}
          ...
          <main className="shop-main">
            {loading ? (
              ...
              <div className="no-products">
                ...
                <p>
                  {filters.category ? 
                    `No items available in ${getCategoryDisplayName(filters.category)} category.` :
